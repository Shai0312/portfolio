...
const data: IData[] = [
    ...
    { image: "/experience.png", title: "Experience", description: "I have experience in web development, and specialize in HTML, CSS, Typescript, and Next.js. I build modern and responsive websites." },
];
