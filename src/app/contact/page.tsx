      ...
      <div className="xs:pl-6 sm:ml-20 md:pl-8 lg:pl-20 lg:w-1/2 xl:w-1/3">
        ...
        <div className="flex mt-6 gap-5 justify-center lg:justify-start xs:px-4 sm:px-8">
          <Link href={"https://www.linkedin.com/in/shaista-abdulhakeem-2935732a6?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"}>
            <img
              className="h-9 w-9 hover:scale-110 block hover:border-red-700 hover:border-2 transition-all duration-300 rounded-full xs:h-8 w-8 sm:h-9 md:h-9"
              src="/in.png"
              alt="linkedin"
            />
          </Link>
          <Link href={"https://www.facebook.com/ukhteali.abdulhakeem.3?mibextid=ZbWKwL"}>
            <img
              className="h-9 w-9 hover:scale-110 block hover:border-red-700 hover:border-2 transition-all duration-300 rounded-full xs:h-7 w-8 sm:h-9 md:h-9"
              src="/face.png"
              alt="facebook"
            />
          </Link>
          <Link href={"https://www.instagram.com/ukhteali_abdulhakeem/profilecard/?igsh=MTg4NTY5NG9zaG4z"}>
            <img
              className="h-10 w-10 hover:scale-110 block hover:border-red-700 hover:border-2 transition-all duration-300 rounded-full xs:h-9 w-9 sm:h-10 md:h-10"
              src="/insta.png"
              alt="instagram"
            />
          </Link>
          <Link href={"https://github.com/Shai0312"}>
            <img
              className="h-9 w-9 hover:scale-110 block hover:border-red-700 hover:border-2 transition-all duration-300 rounded-full xs:h-9 w-9 sm:h-9 md:h-10 w-10"
              src="/github3.png"
              alt="github"
            />
          </Link>
